...
urlpatterns = [
    ...
    # question_views
    path('qeustion/create/', question_views.question_create, name='question_create'),
    ...
    path('comment/create/modify/question/<int:comment_id>/', comment_views.comment_modify_question,
